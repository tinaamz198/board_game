    ...
    private static final RoomDatabase.Callback roomCallback = new RoomDatabase.Callback() {
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            Executors.newSingleThreadExecutor().execute(() -> {
                ...
                // 1. Мои вопросы (Правда или Действие)
                dao.insert(new BoardGame(
                        "Мои вопросы",
                        "Ваш персональный список вопросов для игры 'Правда или Действие'.", // Краткое описание
                        "1. Нажмите на поле описания, чтобы открыть редактор.\n" +
                                "2. Добавьте свои каверзные вопросы или смешные задания.\n" +
                                "3. Нажмите 'Начать игру', чтобы приложение выбирало случайные вопросы из вашего личного списка.\n" +
                                "Идеально подходит для компании, которая хочет играть по своим правилам!", // Правила
                        "game2", true, false, false, "2-10", "Легко", "Своё", 5.0f));

// 2. Рандомайзер (Колесо Фортуны)
                dao.insert(new BoardGame(
                        "Рандомайзер",
                        "Универсальный помощник для принятия решений с помощью крутящегося колеса.", // Краткое описание
                        "1. Добавьте варианты выбора (имена, города, блюда или действия) через кнопку '+ Вариант'.\n" +
                                "2. Вы можете редактировать список в любое время.\n" +
                                "3. Нажмите 'КРУТИТЬ', чтобы запустить колесо.\n" +
                                "4. Дождитесь остановки: стрелка укажет на победителя!", // Правила
                        "random", true, false, false, "1-20", "Легко", "Инструменты", 5.0f));
                // 2. Мафия
